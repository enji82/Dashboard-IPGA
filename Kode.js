/**
 * Dashboard Ijin Penggunaan Gelar Akademik (IPGA) PNS
...
const CONFIG = {
  SPREADSHEET_ID: '1njs4mLiZFZl4ThQjimpKOG5EMYJiu_S7Fy2UFg954dw',
  SHEET_NAME: 'Data',
...
function doGet(e) {
  return HtmlService.createHtmlOutputFromFile('Index')
    .setTitle('Dashboard Ijin Penggunaan Gelar Akademik (IPGA) - Disdikbud Kab. Magelang')
...
function getDashboardData(forceRefresh) {
  try {
    ...
    const cacheKey = 'DASHBOARD_IPGA_DATA_MAGELANG';
  ...
  for (let index = 0; index < rows.length; index++) {
    ...
    // Kolom AG (Index 32): Jenis IPGA (jab fungsional guru, reguler (non guru), penyesuaian ijasah / penyesuaian ijazah)
